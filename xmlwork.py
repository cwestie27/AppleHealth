...
# Steps:
# export the data from apple health and move the exported apple_health_export folder to jupyter folder and delete prior
# export the sleep cycle data and move it to the jupyter folder and rename it sleepdata .
# Change the date range in "ourperiod" variable if needed.
#
...
def pre_process(xmlfileaddress):
    """Pre-processes the XML file by replacing specific bits that would
    normally result in a ParseError
    """

    print("Pre-processing...", end="")
    with open(xmlfileaddress) as f:  ###change this to the correct filename for most recent export from apple
